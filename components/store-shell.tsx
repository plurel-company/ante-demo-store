      ...
      <main className="store-container">
        <section className="store-hero">
          <p className="sec-eyebrow store-hero__eyebrow">
            Open demo · Built on @plurel/react-sdk
          </p>
          ...
          <p className="store-hero__lede">
            ...
            Plurel Pay&apos;s hosted group checkout to split payment with friends.
          </p>
      ...
      <footer className="site-footer">
        <div className="site-footer__inner">
          ...
          <p className="site-footer__dev">
            Built with{" "}
            <a href="https://plurelpay.com/docs/sdk" target="_blank" rel="noreferrer">
              @plurel/react-sdk
            </a>
